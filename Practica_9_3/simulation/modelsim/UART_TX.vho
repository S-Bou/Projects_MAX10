...
SIGNAL \paridad~2_combout\ : std_logic;
SIGNAL \paridad~1_combout\ : std_logic;
SIGNAL \paridad~3_combout\ : std_logic;
SIGNAL \paridad~q\ : std_logic;
...
SIGNAL \tx_data_int[8]~40_combout\ : std_logic;
...
-- Equation(s):
-- \CLK0|Equal0~3_combout\ = (!\CLK0|contador\(10) & (!\CLK0|contador\(8) & (!\CLK0|contador\(9) & !\CLK0|contador\(11))))
...
-- Equation(s):
-- \CLK0|Equal0~4_combout\ = (!\CLK0|contador\(13) & (!\CLK0|contador\(14) & (!\CLK0|contador\(12) & !\CLK0|contador\(15))))
...
PORT MAP (
	...
	datac => \CLK0|contador\(12),
	datad => \CLK0|contador\(15),
...
-- Equation(s):
-- \CLK0|Equal0~1_combout\ = (!\CLK0|contador\(0) & (!\CLK0|contador\(3) & (!\CLK0|contador\(1) & !\CLK0|contador\(2))))
...
-- Equation(s):
-- \CLK0|Equal0~5_combout\ = (\CLK0|Equal0~3_combout\ & (\CLK0|Equal0~4_combout\ & (\CLK0|Equal0~2_combout\ & \CLK0|Equal0~1_combout\)))
...
-- pragma translate_on
PORT MAP (
	datad => \CLK0|contador[9]~38_combout\,
...
-- Equation(s):
-- \CLK0|contador[19]~58_combout\ = \CLK0|contador\(19) $ (!\CLK0|contador[18]~57\)
...
-- Equation(s):
-- \count[1]~2_combout\ = count(1) $ (((\current_state.data~q\ & count(0))))
...
\count[2]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \count[2]~1_combout\ = count(2) $ (((\current_state.data~q\ & (count(1) & count(0)))))
...
-- Equation(s):
-- \Selector13~0_combout\ = (\current_state.data~q\ & \Equal0~0_combout\)
...
-- Equation(s):
-- \Selector12~0_combout\ = (\current_state.start~q\) # ((\current_state.stop~q\) # ((!\current_state.data~q\ & \tx_en~input_o\)))
...
-- Equation(s):
-- \Selector12~1_combout\ = (\Selector12~0_combout\) # ((\current_state.data~q\ & \Equal0~0_combout\))
...
-- Equation(s):
-- \current_state.idle~0_combout\ = (\Selector12~1_combout\ & (!\current_state.stop~q\)) # (!\Selector12~1_combout\ & ((\current_state.idle~q\)))
...
-- Equation(s):
-- \Selector11~0_combout\ = (\tx_en~input_o\ & !\current_state.idle~q\)
...
-- Equation(s):
-- \Selector12~2_combout\ = (\current_state.start~q\ & (((\current_state.data~q\ & !\Selector12~1_combout\)) # (!\current_state.stop~q\))) # (!\current_state.start~q\ & (((\current_state.data~q\ & !\Selector12~1_combout\))))
...
\paridad~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \paridad~0_combout\ = (\reset~input_o\ & !\current_state.idle~q\)
...
-- Equation(s):
-- \tx_data_int[4]~27_combout\ = \tx_data_int[4]~25_combout\ $ (((\current_state.data~q\ & ((\tx_data_int[3]~14_combout\))) # (!\current_state.data~q\ & (\tx_data[4]~input_o\))))
...
PORT MAP (
	...
	datac => \tx_data_int[3]~14_combout\,
	datad => \current_state.data~q\,
	combout => \tx_data_int[4]~27_combout\);

-- Location: LCCOMB_X46_Y52_N2
\tx_data_int[4]~41\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \tx_data_int[4]~41_combout\ = (!\current_state.start~q\ & (!\current_state.stop~q\ & ((\Equal0~0_combout\) # (!\current_state.data~q\))))
...
PORT MAP (
	...
	datac => \current_state.data~q\,
	datad => \Equal0~0_combout\,
	combout => \tx_data_int[4]~41_combout\);
...
PORT MAP (
	clk => \CLK0|clk_sig~clkctrl_outclk\,
	d => \tx_data_int[4]~27_combout\,
	clrn => \reset~input_o\,
	ena => \tx_data_int[4]~41_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \tx_data_int[5]~23_combout\ = \tx_data_int[5]~21_combout\ $ (((\current_state.data~q\ & ((\tx_data_int[4]~26_combout\))) # (!\current_state.data~q\ & (\tx_data[5]~input_o\))))
...
-- Equation(s):
-- \tx_data_int[6]~19_combout\ = \tx_data_int[6]~17_combout\ $ (((\current_state.data~q\ & (\tx_data_int[5]~22_combout\)) # (!\current_state.data~q\ & ((\tx_data[6]~input_o\)))))
...
PORT MAP (
	dataa => \reset~input_o\,
	datab => \tx_data_int[6]~_emulated_q\,
...
-- Equation(s):
-- \tx_data_int[7]~31_combout\ = \tx_data_int[7]~29_combout\ $ (((\current_state.data~q\ & ((\tx_data_int[6]~18_combout\))) # (!\current_state.data~q\ & (\tx_data[7]~input_o\))))
...
\paridad~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \paridad~2_combout\ = \tx_data_int[4]~26_combout\ $ (\tx_data_int[5]~22_combout\ $ (\tx_data_int[6]~18_combout\ $ (\tx_data_int[7]~30_combout\)))
...
\paridad~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \paridad~1_combout\ = \tx_data_int[1]~6_combout\ $ (\tx_data_int[0]~10_combout\ $ (\tx_data_int[2]~2_combout\ $ (\tx_data_int[3]~14_combout\)))
...
PORT MAP (
	...
	datab => \tx_data_int[0]~10_combout\,
	datac => \tx_data_int[2]~2_combout\,
	datad => \tx_data_int[3]~14_combout\,
	combout => \paridad~1_combout\);

-- Location: LCCOMB_X47_Y52_N16
\paridad~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \paridad~3_combout\ = (\paridad~0_combout\ & (\paridad~2_combout\ $ (((\paridad~1_combout\))))) # (!\paridad~0_combout\ & (((\paridad~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \paridad~0_combout\,
	datab => \paridad~2_combout\,
	datac => \paridad~q\,
	datad => \paridad~1_combout\,
	combout => \paridad~3_combout\);
...
-- Equation(s):
-- \tx_data_int[0]~11_combout\ = \tx_data_int[0]~9_combout\ $ (((\current_state.data~q\ & ((\paridad~q\))) # (!\current_state.data~q\ & (\tx_data[0]~input_o\))))
...
-- Equation(s):
-- \tx_data_int[0]~10_combout\ = (\reset~input_o\ & ((\tx_data_int[0]~9_combout\ $ (\tx_data_int[0]~_emulated_q\)))) # (!\reset~input_o\ & (\tx_data[0]~input_o\))
...
-- Equation(s):
-- \tx_data_int[1]~7_combout\ = \tx_data_int[1]~5_combout\ $ (((\current_state.data~q\ & ((\tx_data_int[0]~10_combout\))) # (!\current_state.data~q\ & (\tx_data[1]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \tx_data_int[1]~_emulated_q\,
	datab => \tx_data[1]~input_o\,
	datac => \reset~input_o\,
...
-- Equation(s):
-- \tx_data_int[2]~3_combout\ = \tx_data_int[2]~1_combout\ $ (((\current_state.data~q\ & ((\tx_data_int[1]~6_combout\))) # (!\current_state.data~q\ & (\tx_data[2]~input_o\))))
...
PORT MAP (
	dataa => \reset~input_o\,
	datab => \tx_data_int[2]~_emulated_q\,
	datac => \tx_data_int[2]~1_combout\,
...
-- Equation(s):
-- \tx_data_int[3]~15_combout\ = \tx_data_int[3]~13_combout\ $ (((\current_state.data~q\ & (\tx_data_int[2]~2_combout\)) # (!\current_state.data~q\ & ((\tx_data[3]~input_o\)))))
...
-- Equation(s):
-- \tx_data_int[3]~14_combout\ = (\reset~input_o\ & ((\tx_data_int[3]~13_combout\ $ (\tx_data_int[3]~_emulated_q\)))) # (!\reset~input_o\ & (\tx_data[3]~input_o\))
...
PORT MAP (
	...
	datac => \tx_data_int[3]~13_combout\,
	datad => \tx_data_int[3]~_emulated_q\,
	combout => \tx_data_int[3]~14_combout\);

-- Location: LCCOMB_X46_Y52_N28
\Mux0~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Mux0~0_combout\ = (count(0) & ((count(1)) # ((\tx_data_int[1]~6_combout\)))) # (!count(0) & (!count(1) & (\tx_data_int[0]~10_combout\)))
...
PORT MAP (
	...
	datab => count(1),
	datac => \tx_data_int[0]~10_combout\,
	datad => \tx_data_int[1]~6_combout\,
	combout => \Mux0~0_combout\);

-- Location: LCCOMB_X46_Y52_N30
\Selector0~6\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Selector0~6_combout\ = (count(1) & ((\Mux0~0_combout\ & (\tx_data_int[3]~14_combout\)) # (!\Mux0~0_combout\ & ((\tx_data_int[2]~2_combout\))))) # (!count(1) & (((\Mux0~0_combout\))))
...
-- Equation(s):
-- \Selector0~5_combout\ = (count(0) & (((\tx_data_int[7]~30_combout\) # (!count(1))))) # (!count(0) & ((\tx_data_int[4]~26_combout\) # ((count(1)))))
...
-- Equation(s):
-- \Selector0~7_combout\ = (count(2) & (((\Selector0~5_combout\)))) # (!count(2) & (\Selector0~6_combout\ & ((!count(3)))))
...
-- Equation(s):
-- \Selector0~3_combout\ = (count(1) & (!\tx_data_int[6]~18_combout\ & ((!count(0))))) # (!count(1) & (((!\tx_data_int[5]~22_combout\ & count(0)))))
...
-- Equation(s):
-- \Selector0~4_combout\ = (\current_state.data~q\ & (((!\Selector0~3_combout\ & !count(3))) # (!count(2))))
...
-- Equation(s):
-- \Selector0~2_combout\ = (\current_state.stop~q\) # (!\current_state.idle~q\)
...
\tx_data_int[8]~40\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \tx_data_int[8]~40_combout\ = (\reset~input_o\ & ((\Selector13~0_combout\ & (\tx_data_int[7]~30_combout\)) # (!\Selector13~0_combout\ & ((tx_data_int(8)))))) # (!\reset~input_o\ & (((tx_data_int(8)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \tx_data_int[7]~30_combout\,
	datab => \reset~input_o\,
	datac => tx_data_int(8),
	datad => \Selector13~0_combout\,
	combout => \tx_data_int[8]~40_combout\);
...
-- Equation(s):
-- \Selector0~0_combout\ = (count(3) & tx_data_int(8))
...
-- Equation(s):
-- \Selector0~1_combout\ = (\current_state.data~q\ & ((\Equal0~0_combout\ & (!\tx~reg0_q\)) # (!\Equal0~0_combout\ & ((\Selector0~0_combout\)))))
...
-- Equation(s):
-- \Selector0~8_combout\ = (!\Selector0~2_combout\ & (!\Selector0~1_combout\ & ((!\Selector0~4_combout\) # (!\Selector0~7_combout\))))
