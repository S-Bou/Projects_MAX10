...
-- EXT_KEY	=>  Location: PIN_AA2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \EXT_KEY~input_o\ : std_logic;
...
SIGNAL \inst999|inst3~feeder_combout\ : std_logic;
...
\EXT_KEY~input\ : fiftyfivenm_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	listen_to_nsleep_signal => "false",
...
-- Equation(s):
-- \inst999|inst|inst~feeder_combout\ = \EXT_KEY~input_o\
...
-- Equation(s):
-- \inst999|inst10|reg_fstate.Q2~0_combout\ = (\inst999|inst10|fstate.Q2~q\ & (!\Reset~input_o\ & !\inst999|inst|inst1~q\))
...
-- Equation(s):
-- \inst999|inst1|auto_generated|cmpr1|aneb_result_wire[0]~1_combout\ = (!\inst999|inst1|auto_generated|counter_reg_bit\(3) & (!\inst999|inst1|auto_generated|counter_reg_bit\(4) & (\inst999|inst1|auto_generated|counter_reg_bit\(5) & 
-- \inst999|inst1|auto_generated|counter_reg_bit\(6))))
...
PORT MAP (
	...
	datac => \inst999|inst1|auto_generated|counter_reg_bit\(5),
	datad => \inst999|inst1|auto_generated|counter_reg_bit\(6),
...
-- Equation(s):
-- \inst999|inst1|auto_generated|cmpr1|aneb_result_wire[0]~2_combout\ = (\inst999|inst1|auto_generated|counter_reg_bit\(0) & (!\inst999|inst1|auto_generated|counter_reg_bit\(2) & (\inst999|inst1|auto_generated|cmpr1|aneb_result_wire[0]~1_combout\ & 
-- !\inst999|inst1|auto_generated|counter_reg_bit\(1))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst999|inst1|auto_generated|counter_reg_bit\(0),
	datab => \inst999|inst1|auto_generated|counter_reg_bit\(2),
	datac => \inst999|inst1|auto_generated|cmpr1|aneb_result_wire[0]~1_combout\,
	datad => \inst999|inst1|auto_generated|counter_reg_bit\(1),
...
-- ((\inst999|inst1|auto_generated|cmpr1|aneb_result_wire[0]~0_combout\ & \inst999|inst1|auto_generated|cmpr1|aneb_result_wire[0]~2_combout\)))
...
-- Equation(s):
-- \inst999|inst1|auto_generated|cmpr1|aneb_result_wire[0]~0_combout\ = (!\inst999|inst1|auto_generated|counter_reg_bit\(8) & (\inst999|inst1|auto_generated|counter_reg_bit\(7) & (!\inst999|inst1|auto_generated|counter_reg_bit\(9) & 
-- \inst999|inst1|auto_generated|counter_reg_bit\(10))))
...
PORT MAP (
	...
	datad => \inst999|inst1|auto_generated|counter_reg_bit\(10),
...
-- Equation(s):
-- \inst999|inst10|reg_fstate.Q3~0_combout\ = (\inst999|inst10|fstate.Q2~q\ & (!\Reset~input_o\ & \inst999|inst|inst1~q\))
...
PORT MAP (
	dataa => \Reset~input_o\,
	datab => \inst999|inst10|reg_fstate.Q3~0_combout\,
...
-- pragma translate_on
PORT MAP (
	datab => \inst999|inst10|reg_fstate.Q0~0_combout\,
	datac => \inst999|inst10|fstate.Q3~q\,
	datad => \inst999|inst1|auto_generated|cout_actual~combout\,
...
\inst999|inst3~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst999|inst3~feeder_combout\ = \inst999|inst10|xDeb_n~0_combout\
...
-- pragma translate_on
PORT MAP (
	datab => \inst999|inst10|xDeb_n~0_combout\,
	combout => \inst999|inst3~feeder_combout\);
...
PORT MAP (
	clk => \Clock~input_o\,
	d => \inst999|inst3~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \inst999|inst3~q\);
...
-- Equation(s):
-- \inst33|sub|19~0_combout\ = \inst33|sub|19~q\ $ (((\inst33|sub|17~q\ & (\inst33|sub|18~q\ & \inst33|sub|16~q\))))
...
-- Equation(s):
-- \inst555|86~0_combout\ = (\inst33|sub|18~q\ & (\inst33|sub|17~q\ & (\inst33|sub|16~q\))) # (!\inst33|sub|18~q\ & ((\inst33|sub|17~q\) # ((\inst33|sub|16~q\ & !\inst33|sub|19~q\))))
...
-- Equation(s):
-- \inst555|87~combout\ = (\inst33|sub|18~q\ & (\inst33|sub|17~q\ & (\inst33|sub|16~q\))) # (!\inst33|sub|18~q\ & (!\inst33|sub|17~q\ & ((!\inst33|sub|19~q\))))
...
-- Equation(s):
-- \inst555|81~0_combout\ = (\inst33|sub|18~q\ & (((\inst33|sub|17~q\ & \inst33|sub|19~q\)) # (!\inst33|sub|16~q\))) # (!\inst33|sub|18~q\ & ((\inst33|sub|17~q\ & ((\inst33|sub|19~q\))) # (!\inst33|sub|17~q\ & (\inst33|sub|16~q\ & !\inst33|sub|19~q\))))
